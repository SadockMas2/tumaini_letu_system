...
<head>
    ...
    <title>Échéancier Groupe - <?php echo e($credit->compte->nom); ?></title>
    <style>
...
<body>
    ...
    <div class="no-print" style="text-align:center; margin-bottom:15px; padding:15px; background:linear-gradient(135deg,#667eea 0%,#764ba2 100%); color:white; border-radius:8px;">
        ...
        <p style="margin:5px 0; font-size:12px; opacity:0.9;">
            <?php echo e($credit->compte->nom); ?> - <?php echo e($credit->compte->numero_compte); ?>
    ...
    <div>
        ...
        <div class="ref-date">
            <div>RÉF : ÉCH-G<?php echo e($credit->id); ?>-<?php echo e(date('Ymd')); ?></div>
...
</html><?php /**PATH C:\laragon\www\tumainiletusystem2.0\resources\views/credits/echeanciers-groupe.blade.php ENDPATH**/ ?>