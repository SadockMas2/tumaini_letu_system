    ...
    <div class="w-full max-w-6xl mx-4 my-8">
        ...
        <div class="details-card rounded-2xl p-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
                <?php if($compte->credits->where('statut_demande', 'approuve')->count() > 0 || $compte->creditsGroupe->where('statut_demande', 'approuve')->count() > 0): ?>
                    <a 
                        href="<?php echo e(route('credits.payment', $compte->id)); ?>" 
...
</html><?php /**PATH C:\STORAGE\TUMAINI LETU\System\tumainiletusystem\tumainiletusystem2.0\resources\views/comptes/details.blade.php ENDPATH**/ ?>