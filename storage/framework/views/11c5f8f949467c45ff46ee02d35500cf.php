...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen py-8 px-4">
        ...
        <div class="max-w-7xl mx-auto">
            <!-- Search Bar -->
            <form method="GET" action="<?php echo e(route('galerie.clients')); ?>" class="flex justify-center mb-8">
                <div class="relative w-full max-w-2xl">
                    ...
                    >
                    <?php if($search): ?>
                    <a href="<?php echo e(route('galerie.clients')); ?>" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                ...
                <div class="stats-card rounded-xl p-4 text-center shadow-lg">
                    <div class="text-2xl font-bold text-green-600">
                        <?php echo e($stats['avec_email']); ?>

                    </div>
                    <div class="text-sm text-gray-600">Avec Email</div>
                    <div class="text-xs text-gray-500">
                        <?php if($stats['total'] > 0): ?>
                            <?php echo e(number_format(($stats['avec_email'] / $stats['total']) * 100, 0)); ?>%
                        <?php else: ?>
                            0%
                        <?php endif; ?>
                    </div>
                ...
                <div class="stats-card rounded-xl p-4 text-center shadow-lg">
                    <div class="text-2xl font-bold text-blue-600">
                        <?php echo e($stats['avec_telephone']); ?>

                    </div>
                    <div class="text-sm text-gray-600">Avec Téléphone</div>
                    <div class="text-xs text-gray-500">
                        <?php if($stats['total'] > 0): ?>
                            <?php echo e(number_format(($stats['avec_telephone'] / $stats['total']) * 100, 0)); ?>%
                        <?php else: ?>
                            0%
                        <?php endif; ?>
                    </div>
                ...
                <div class="stats-card rounded-xl p-4 text-center shadow-lg">
                    <div class="text-2xl font-bold text-orange-600">
                        <?php echo e($stats['avec_signature']); ?>

                    </div>
                    <div class="text-sm text-gray-600">Avec Signature</div>
                    <div class="text-xs text-gray-500">
                        <?php if($stats['total'] > 0): ?>
                            <?php echo e(number_format(($stats['avec_signature'] / $stats['total']) * 100, 0)); ?>%
                        <?php else: ?>
                            0%
                        <?php endif; ?>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-12">
                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div 
                            ...
                            onclick="showClientDetails(<?php echo e($client->id); ?>)"
                        >
                            <div class="relative overflow-hidden">
                                <img 
                                    src="<?php echo e($client->getImageUrl()); ?>" 
                                    alt="<?php echo e($client->nom); ?> <?php echo e($client->prenom); ?>"
                                    class="client-photo w-full h-64 object-cover"
                                    onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($client->nom . '+' . $client->prenom)); ?>&background=667eea&color=fff&size=300'"
                                >
                            ...
                            <div class="p-4">
                                ...
                                <?php if($client->postnom): ?>
                                    <p class="text-sm text-gray-600 text-center">
                                        <?php echo e($client->postnom); ?>

                                    </p>
                                <?php endif; ?>
                                <?php if($client->email): ?>
                                    <p class="text-sm text-gray-600 text-center truncate" title="<?php echo e($client->email); ?>">
                                        <i class="fas fa-envelope mr-1"></i><?php echo e($client->email); ?>

                                    </p>
                                <?php endif; ?>
                                <p class="text-xs text-gray-500 text-center mt-2">
                                    <i class="fas fa-id-card mr-1"></i>#<?php echo e($client->numero_membre); ?>
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="stats-card rounded-xl p-4 shadow-lg">
                            <div class="flex items-center space-x-2">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($clients->previousPageUrl()); ?>" class="px-3 py-1 bg-blue-500 text-white rounded-md text-sm hover:bg-blue-600 transition-colors">
                                        Précédent
                                    </a>
                                <?php endif; ?>

                                <span class="text-sm text-gray-600">
                                    Page <?php echo e($clients->currentPage()); ?> sur <?php echo e($clients->lastPage()); ?>

                                </span>

                                <?php if($clients->hasMorePages()): ?>
                                    <a href="<?php echo e($clients->nextPageUrl()); ?>" class="px-3 py-1 bg-blue-500 text-white rounded-md text-sm hover:bg-blue-600 transition-colors">
                                        Suivant
                                    </a>
                                <?php else: ?>
            ...
            <?php else: ?>
                ...
                <div class="bg-white rounded-2xl p-12 text-center border-2 border-dashed border-gray-300">
                    ...
                    <p class="text-gray-500 mb-6 max-w-md mx-auto">
                        <?php echo e($search ? 'Aucun membre ne correspond à votre recherche.' : 'Commencez par ajouter vos premiers membres à la galerie.'); ?>

                    </p>
                    <?php if(!$search): ?>
                        <a href="<?php echo e(route('filament.admin.resources.clients.create')); ?>" 
...
</html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/galerie-clients.blade.php ENDPATH**/ ?>