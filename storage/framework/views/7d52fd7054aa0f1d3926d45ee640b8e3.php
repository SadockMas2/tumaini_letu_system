        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="space-y-1">
                ...
                <div class="text-lg font-semibold text-gray-900 p-2 bg-gray-50 rounded">
                    ...
                    ?>
                    <?php echo e($types[$type_operation] ?? $type_operation); ?>
            ...
            <div class="space-y-1">
                ...
                <div class="text-2xl font-bold text-green-600 p-2 bg-green-50 rounded">
                    <?php echo e(number_format($montant, 2)); ?> <?php echo e($devise); ?>
        ...
        <div class="border-t pt-4">
            ...
            <div class="space-y-2">
                ...
                <div class="text-md font-medium text-gray-900 p-2 bg-blue-50 rounded">
                    ...
                    <?php echo e($client_nom); ?>

                </div>
            </div>
            <?php endif; ?>

            <?php if($compte_numero): ?>
...
</div><?php /**PATH C:\laragon\www\tumainiletusystem2.0\resources\views/filament/operations/confirmation-tresorerie.blade.php ENDPATH**/ ?>