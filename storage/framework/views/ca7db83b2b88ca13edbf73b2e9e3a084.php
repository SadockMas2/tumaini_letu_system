                                    ...
                                    <?php if($compteMembre): ?>
                                        <tr class="border-b border-green-100 hover:bg-green-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-right font-semibold text-green-600">
                                                <?php echo e(number_format($details['montant_accorde'], 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                                            </td>
                                            <td class="px-4 py-3 text-right text-gray-600">
                                                <?php echo e(number_format($details['remboursement_hebdo'], 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                                            </td>
                                            <td class="px-4 py-3 text-right text-orange-600">
                                                <?php echo e(number_format($details['caution'], 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                                            </td>
                                            <td class="px-4 py-3 text-right font-semibold text-purple-600">
                                                <?php echo e(number_format($details['montant_total'], 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                                            </td>
                                            <td class="px-4 py-3 text-center">
                                                <?php if($creditMembre && $creditMembre->montant_total > 0): ?>
...
</html><?php /**PATH C:\STORAGE\TUMAINI LETU\System\tumainiletusystem\tumainiletusystem2.0\resources\views/credits/details-groupe.blade.php ENDPATH**/ ?>