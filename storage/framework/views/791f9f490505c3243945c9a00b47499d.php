...
<body>
    ...
    <div class="ref-date">
        <div>N/REF : RAPP-COFFRES-<?php echo e(\Carbon\Carbon::now()->format('Ymd-His')); ?></div>
    ...
    <div class="section">
        <div style="text-align: center; margin-bottom: 15px;">
            ...
            <p style="font-size: 12px; color: #000;">Synthèse de tous les coffres - <?php echo e($rapport['total_coffres']); ?> coffre(s)</p>
        </div>
    </div>
...
</html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/pdf/rapport-coffres-global.blade.php ENDPATH**/ ?>