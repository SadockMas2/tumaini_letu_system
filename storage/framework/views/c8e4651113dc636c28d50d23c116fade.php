        ...
        <div class="details-card rounded-2xl p-8">
            ...
            <div class="text-center mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-2">
                    Compte Épargne <span class="text-green-600"><?php echo e($compte->numero_compte); ?></span>
                </h2>
                <div class="flex flex-wrap justify-center gap-4 text-sm text-gray-600 mb-4">
                    <div class="flex items-center bg-blue-50 rounded-full px-4 py-2">
                        ...
                        <span class="font-medium"><?php echo e($compte->nom_complet); ?></span>
                    </div>
                    ...
                    <div class="flex items-center bg-purple-50 rounded-full px-4 py-2">
                        ...
                        <span class="font-medium"><?php echo e(ucfirst($compte->type_compte)); ?></span>
                    </div>
                    <?php if($compte->type_compte === 'groupe_solidaire'): ?>
...
</html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/comptes-epargne/details.blade.php ENDPATH**/ ?>