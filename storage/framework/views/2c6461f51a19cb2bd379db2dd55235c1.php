...
<body>
    ...
    <div class="ref-date">
        <div>N/REF : RAPP-COMPTES-<?php echo e(\Carbon\Carbon::now()->format('Ymd-His')); ?></div>
    ...
    <div class="section">
        ...
        <div class="totals-grid">
            ...
            <div class="total-card">
                ...
                <div class="total-value"><?php echo e($rapport['totaux']['usd']['credits_actifs']); ?></div>
            </div>
            <div class="total-card">
                <div class="total-label">CRÉDITS ACTIFS CDF</div>
                <div class="total-value"><?php echo e($rapport['totaux']['cdf']['credits_actifs']); ?></div>
            </div>
            <div class="total-card">
                <div class="total-label">DÉPÔTS JOUR USD</div>
                <div class="total-value devise-usd montant"><?php echo e(number_format($rapport['totaux']['usd']['depots_jour'], 2)); ?> $</div>
            </div>
            <div class="total-card">
                <div class="total-label">RETRAITS JOUR USD</div>
                <div class="total-value devise-usd montant"><?php echo e(number_format($rapport['totaux']['usd']['retraits_jour'], 2)); ?> $</div>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        <div class="section-title">LISTE DES COMPTES (<?php echo e($rapport['nombre_total_comptes']); ?>)</div>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($compte->type_compte === 'individuel'): ?>
                            <?php echo e($compte->prenom); ?> <?php echo e($compte->nom); ?>   <?php echo e($compte->postnom); ?>  <?php echo e($compte->prenom); ?>

                        <?php else: ?>
                            <?php echo e($compte->nom); ?>
                    ...
                    <td class="text-center <?php echo e($compte->devise === 'USD' ? 'devise-usd' : 'devise-cdf'); ?>">
                        <?php echo e($compte->devise); ?>

                    </td>
                    <td class="text-right montant <?php echo e($compte->devise === 'USD' ? 'devise-usd' : 'devise-cdf'); ?>">
                    ...
                    <td class="text-center">
                        ...
                        <?php elseif($compte->statut === 'inactif'): ?>
                    ...
                    <td class="text-center">
                        ...
                        ?>
                        <?php echo e($creditsActifs > 0 ? $creditsActifs : '-'); ?>
                    ...
                    <td class="text-center">
                        ...
                        ?>
                        <?php if($depotsJour > 0): ?>
                            <span class="montant"><?php echo e(number_format($depotsJour, 2)); ?></span>
                        <?php else: ?>
                            -
                        <?php endif; ?>
                    </td>
                    <td class="text-center">
                        ...
                        ?>
                        <?php if($retraitsJour > 0): ?>
                            <span class="montant"><?php echo e(number_format($retraitsJour, 2)); ?></span>
                        <?php else: ?>
                            -
                        <?php endif; ?>
                    </td>
                    <td style="font-size: 9px;">
                        Membre: <?php echo e($compte->numero_membre); ?><br>
                        Créé: <?php echo e($compte->created_at->format('d/m/Y')); ?>
...
</html><?php /**PATH C:\laragon\www\tumainiletusystem2.0\resources\views/rapports/comptes.blade.php ENDPATH**/ ?>