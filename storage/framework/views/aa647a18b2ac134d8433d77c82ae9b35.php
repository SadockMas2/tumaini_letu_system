...
<body>
    <div class="container">
        ...
        <form action="<?php echo e(route('rapport.epargne')); ?>" method="GET">
            ...
            <div style="text-align: center; margin-top: 15px;">
                <a href="<?php echo e(route('rapport.epargne')); ?>" style="color: #3498db; text-decoration: none;">
...
</html><?php /**PATH C:\laragon\www\tumainiletusystem2.0\resources\views/rapports/formulaire-epargne.blade.php ENDPATH**/ ?>