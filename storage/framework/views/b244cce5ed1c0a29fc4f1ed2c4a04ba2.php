    ...
    <div class="summary-section">
        ...
        <div class="totals-grid">
            ...
            <div class="total-card">
                ...
                <div class="total-value montant"><?php echo e(number_format($totaux['total_montant_accorde'] - $totaux['total_capital_rembourse'], 2)); ?> $</div>
            </div>
            <div class="total-card">
                <div class="total-label">PORTEFEUILLE INTÉRÊTS</div>
                <div class="total-value montant"><?php echo e(number_format($totaux['total_interets_attendus'] - $totaux['total_interets_payes'], 2)); ?> $</div>
            </div>
            <div class="total-card">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e(\Illuminate\Support\Str::limit($credit['agent'], 12)); ?></td>
                 <td><?php echo e(\Illuminate\Support\Str::limit($credit['superviseur'], 12)); ?></td>
    ...
    <div style="margin-top: 15px; font-size: 10px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 10px;">
            <div style="border: 1px solid #000; padding: 10px; border-radius: 4px;">
                ...
                <div>Capital accordé initial: <strong class="montant"><?php echo e(number_format($totaux['total_montant_accorde'], 2)); ?> $</strong></div>
                <div>Capital déjà remboursé: <strong class="montant"><?php echo e(number_format($totaux['total_capital_rembourse'], 2)); ?> $</strong></div>
                <div style="border-top: 1px solid #ccc; margin-top: 5px; padding-top: 5px;">
                    Capital restant à recouvrer: <strong class="montant" style="color: #dc3545;"><?php echo e(number_format($totaux['total_montant_accorde'] - $totaux['total_capital_rembourse'], 2)); ?> $</strong>
                </div>
            </div>
            
            <div style="border: 1px solid #000; padding: 10px; border-radius: 4px;">
                <div style="font-weight: bold; margin-bottom: 8px; color: #2c5282;">PORTEFEUILLE INTÉRÊTS</div>
                <div>Intérêts attendus totaux: <strong class="montant"><?php echo e(number_format($totaux['total_interets_attendus'], 2)); ?> $</strong></div>
                <div>Intérêts déjà payés: <strong class="montant"><?php echo e(number_format($totaux['total_interets_payes'], 2)); ?> $</strong></div>
                <div style="border-top: 1px solid #ccc; margin-top: 5px; padding-top: 5px;">
                    Intérêts restants à percevoir: <strong class="montant" style="color: #28a745;"><?php echo e(number_format($totaux['total_interets_attendus'] - $totaux['total_interets_payes'], 2)); ?> $</strong>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/filament/exports/rapport-credits-html.blade.php ENDPATH**/ ?>