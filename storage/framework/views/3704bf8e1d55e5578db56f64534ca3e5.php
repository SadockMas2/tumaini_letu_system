    ...
    <body class="font-sans antialiased">
        <div class="w-full max-w-6xl mx-4 my-8">
            ...
            <div class="details-card rounded-2xl p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 text-sm text-gray-600 mb-4">
                        ...
                        <div class="flex items-center bg-purple-50 rounded-full px-4 py-2">
                            ...
                            <span class="font-medium"><?php echo e($compte->devise); ?></span>
                        </div>
                        <?php if(str_starts_with($compte->numero_compte, 'GS')): ?>
                    ...
                    <div class="stat-card bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-l-purple-400">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-2xl font-bold text-purple-600">
                                <?php echo e($compte->credits->where('statut_demande', 'approuve')->count() + $compte->creditsGroupe->where('statut_demande', 'approuve')->count()); ?>
                    ...
                    <div class="stat-card bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border-l-orange-400">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-2xl font-bold text-orange-600">
                                <?php echo e($compte->credits->where('statut_demande', 'en_attente')->count() + $compte->creditsGroupe->where('statut_demande', 'en_attente')->count()); ?>
                ...
                <?php if($compte->credits->where('statut_demande', 'approuve')->count() > 0): ?>
                    <?php
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="stat-card bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-l-blue-400">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <span class="text-2xl font-bold text-blue-600">
                                    <?php echo e(number_format($creditActif->montant_accorde, 2, ',', ' ')); ?>
                        ...
                        <div class="stat-card bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-l-purple-400">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <span class="text-2xl font-bold text-purple-600">
                                    <?php echo e(number_format($creditActif->montant_total, 2, ',', ' ')); ?>
                        ...
                        <div class="stat-card bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-l-green-400">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <span class="text-2xl font-bold text-green-600">
                                    <?php echo e(number_format($creditActif->remboursement_hebdo, 2, ',', ' ')); ?>
                        ...
                        <div class="stat-card bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border-l-orange-400">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <span class="text-xl font-bold text-orange-600 capitalize">
                                    <?php echo e($creditActif->type_credit); ?>

                                </span>
                            </div>
                            <p class="text-sm text-gray-600 font-medium">Type Crédit</p>
                            <p class="text-xs text-gray-500 mt-1">
                                <?php echo e($creditActif->type_credit === 'individuel' ? 'Individuel' : 'Groupe'); ?>
...
<div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
    ...
    <?php
        // Pour les crédits individuels (section actuelle)
        if (isset($creditActif) && $creditActif instanceof \App\Models\Credit) {
            // Crédit individuel - calculer les paiements réels
            $totalPaiements = $creditActif->paiements()->sum('montant_paye');
            $montantDejaRembourse = $totalPaiements;
            $montantAccorde = $creditActif->montant_accorde;
            
            // Calculer la progression
            $progress = ($montantAccorde > 0) ? ($montantDejaRembourse / $montantAccorde) * 100 : 0;
            $progress = max(0, min(100, $progress));
            
            // Calculer le reste à payer (montant total moins ce qui a été payé)
            $resteAPayer = max(0, $creditActif->montant_total - $montantDejaRembourse);
        } else {
            $montantDejaRembourse = 0;
            $montantAccorde = 1;
            $progress = 0;
            $resteAPayer = isset($creditActif) ? $creditActif->montant_total : 0;
        }
    ?>
    ...
    <div class="mb-4">
        <div class="flex justify-between text-sm text-gray-600 mb-2">
            ...
            <span class="font-semibold"><?php echo e(number_format($progress, 1)); ?>%</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-3">
            <div class="progress-bar rounded-full h-3" style="width: <?php echo e($progress); ?>%"></div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 text-center">
        <div class="bg-white rounded-lg p-3 border border-gray-200">
            ...
            <p class="text-lg font-bold text-green-600">
                <?php echo e(number_format($montantDejaRembourse, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
        ...
        <div class="bg-white rounded-lg p-3 border border-gray-200">
            ...
            <p class="text-lg font-bold text-orange-600">
                <?php echo e(number_format($resteAPayer, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
                                    ...
                                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                                        <div class="flex justify-between items-start mb-2">
                                            ...
                                            <span class="text-sm text-gray-500 bg-blue-100 px-2 py-1 rounded">
                                                <?php echo e($creditActif->date_octroi->format('d/m/Y')); ?>
                                    ...
                                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                                        <div class="flex justify-between items-start mb-2">
                                            ...
                                            <span class="text-sm text-gray-500 bg-green-100 px-2 py-1 rounded">
                                                <?php echo e($creditActif->date_echeance->format('d/m/Y')); ?>
                                    ...
                                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                                        <div class="flex justify-between items-start mb-2">
                                            ...
                                            <span class="text-sm text-gray-500 bg-purple-100 px-2 py-1 rounded">
                                                <?php echo e(number_format($creditActif->remboursement_hebdo, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
                ...
                <?php elseif($compte->creditsGroupe->where('statut_demande', 'approuve')->count() > 0): ?>
                    ...
                    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                            <div class="bg-white rounded-lg p-4 border border-purple-100">
                                ...
                                <p class="text-xl font-bold text-purple-600">
                                    <?php echo e(number_format($creditGroupeActif->montant_accorde ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
                            ...
                            <div class="bg-white rounded-lg p-4 border border-purple-100">
                                ...
                                <p class="text-xl font-bold text-purple-600">
                                    <?php echo e(number_format($creditGroupeActif->montant_total ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
                            ...
                            <div class="bg-white rounded-lg p-4 border border-purple-100">
                                ...
                                <p class="text-xl font-bold text-purple-600">
                                    <?php echo e(number_format($creditGroupeActif->remboursement_hebdo_total ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
                            ...
                            <div class="bg-white rounded-lg p-4 border border-purple-100">
                                ...
                                <p class="text-xl font-bold text-purple-600">
                                    <?php echo e(number_format($creditGroupeActif->caution_totale ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
                        ...
                        <div class="flex space-x-4">
                            <a href="<?php echo e(route('credits.details-groupe', $creditGroupeActif->id)); ?>" 
                            ...
                            <a href="<?php echo e(route('credits.echeanciers-groupe', $creditGroupeActif->id)); ?>" 
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php $__currentLoopData = $compte->credits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $credit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            <?php echo e(number_format($credit->montant_accorde ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium <?php echo e(($credit->montant_total ?? 0) > 0 ? 'text-orange-600' : 'text-green-600'); ?>">
                                            <?php echo e(number_format($credit->montant_total ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <?php echo e($credit->remboursement_hebdo ? number_format($credit->remboursement_hebdo, 2, ',', ' ') : 'N/A'); ?> <?php echo e($compte->devise); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <?php echo e($credit->date_octroi ? $credit->date_octroi->format('d/m/Y') : 'N/A'); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <?php echo e($credit->date_echeance ? $credit->date_echeance->format('d/m/Y') : 'N/A'); ?>
                ...
                <?php if($compte->creditsGroupe->count() > 0): ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-purple-100">
                                <?php $__currentLoopData = $compte->creditsGroupe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $creditGroupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-purple-50 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            <?php echo e(number_format($creditGroupe->montant_accorde ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-purple-600">
                                            <?php echo e(number_format($creditGroupe->montant_total ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <?php echo e(number_format($creditGroupe->remboursement_hebdo_total ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <?php echo e($creditGroupe->date_octroi ? $creditGroupe->date_octroi->format('d/m/Y') : 'N/A'); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <?php echo e($creditGroupe->date_echeance ? $creditGroupe->date_echeance->format('d/m/Y') : 'N/A'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($colorClass); ?>">
                                            <i class="fas 
                                                <?php echo e($creditGroupe->statut_demande === 'en_attente' ? 'fa-clock' : 
                                                ($creditGroupe->statut_demande === 'approuve' ? 'fa-check' : 
                                                ($creditGroupe->statut_demande === 'rembourse' ? 'fa-flag-checkered' : 'fa-times'))); ?> 
                                                mr-1">
                                            </i>
                                            <?php echo e(ucfirst($creditGroupe->statut_demande)); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex space-x-2">
                                            <?php if($creditGroupe->statut_demande === 'approuve'): ?>
                                                <a 
                                                    href="<?php echo e(route('credits.details-groupe', $creditGroupe->id)); ?>" 
                                                ...
                                                <a 
                                                    href="<?php echo e(route('credits.echeanciers-groupe', $creditGroupe->id)); ?>" 
                ...
                <?php if($compte->credits->count() === 0 && $compte->creditsGroupe->count() === 0): ?>
        ...
        <div id="releveContent" class="hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($mouvements->previousPageUrl()); ?>" class="px-3 py-1 bg-blue-500 text-white rounded-md text-sm hover:bg-blue-600 transition-colors">
                                Précédent
                            </a>
                        <?php endif; ?>

                        <?php if($mouvements->hasMorePages()): ?>
                            <a href="<?php echo e($mouvements->nextPageUrl()); ?>" class="px-3 py-1 bg-blue-500 text-white rounded-md text-sm hover:bg-blue-600 transition-colors">
                                Suivant
                            </a>
                        <?php else: ?>
            ...
            <?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
                    ...
                    <?php if($compte->credits->where('statut_demande', 'en_attente')->count() > 0): ?>
                        <a 
                            href="<?php echo e(route('credits.approval', $compte->credits->where('statut_demande', 'en_attente')->first()->id)); ?>" 
                    ...
                    <?php if($compte->creditsGroupe->where('statut_demande', 'en_attente')->count() > 0): ?>
                        <a 
                            href="<?php echo e(route('credits.approval-groupe', $compte->creditsGroupe->where('statut_demande', 'en_attente')->first()->id)); ?>" 
                ...
                <?php if($compte->credits->where('statut_demande', 'approuve')->count() > 0): ?>
                <a 
                    href="<?php echo e(route('credits.echeancier', $compte->credits->where('statut_demande', 'approuve')->first()->id)); ?>" 
                    target="_blank"
    ...
    function exportReleve() {
        ...
        // Exemple : window.location.href = "<?php echo e(route('comptes.export-releve', $compte->id)); ?>";
    }
    ...
    function exportReleve() {
        ...
        if (releveContent.classList.contains('hidden')) {
            ...
            setTimeout(() => {
                window.location.href = "<?php echo e(route('comptes.export-releve', $compte->id)); ?>";
            }, 1000);
        } else {
    ...
    </html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/comptes/details.blade.php ENDPATH**/ ?>