...
<head>
    <meta charset="utf-8">
    <title>Relevé de Compte - <?php echo e($compte->numero_compte); ?></title>
    <style>
        body { 
...
<body>
    ...
    <div class="info-client">
        ...
        <div class="info-item">
            ...
            <span><?php echo e($compte->numero_membre); ?></span>
        </div>
        <div class="info-item">
            <span class="info-label">Type de compte:</span>
            <span><?php echo e($compte->type_compte === 'individuel' ? 'Individuel' : 'Groupe Solidaire'); ?></span>
        </div>
        <div class="info-item">
            <span class="info-label">Solde actuel:</span>
            <span class="<?php echo e($compte->devise === 'USD' ? 'devise-usd' : 'devise-cdf'); ?>">
        ...
        <div class="summary-grid">
            <div class="summary-item">
                <div class="summary-value text-green-600">
                    <?php echo e(number_format($statsMouvements['total_depots'] ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>

                </div>
                <div class="summary-label">Total Dépôts</div>
                <div class="summary-count"><?php echo e($statsMouvements['nombre_depots'] ?? 0); ?> opérations</div>
            </div>
            <div class="summary-item">
                <div class="summary-value text-red-600">
                    <?php echo e(number_format($statsMouvements['total_retraits'] ?? 0, 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>

                </div>
                <div class="summary-label">Total Retraits</div>
                <div class="summary-count"><?php echo e($statsMouvements['nombre_retraits'] ?? 0); ?> opérations</div>
            </div>
            <div class="summary-item">
                <div class="summary-value text-blue-600">
                    <?php echo e(number_format(($statsMouvements['total_depots'] ?? 0) - ($statsMouvements['total_retraits'] ?? 0), 2, ',', ' ')); ?> <?php echo e($compte->devise); ?>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($mouvement->reference ?? 'N/A'); ?></td>
                <td>
                    <?php echo e($mouvement->description ?? 'Transaction'); ?>

                    <?php if($mouvement->nom_deposant): ?>
                        <br><small>Par: <?php echo e($mouvement->nom_deposant); ?></small>
                    <?php endif; ?>
                </td>
                <td class="<?php echo e($mouvement->type === 'depot' ? 'depot' : 'retrait'); ?>">
                    <?php echo e($mouvement->type === 'depot' ? '+' : '-'); ?>

                    <?php echo e(number_format($mouvement->montant, 2, ',', ' ')); ?> <?php echo e($mouvement->devise ?? $compte->devise); ?>

                </td>
                <td><?php echo e(number_format($mouvement->solde_avant, 2, ',', ' ')); ?> <?php echo e($mouvement->devise ?? $compte->devise); ?></td>
                <td><?php echo e(number_format($mouvement->solde_apres, 2, ',', ' ')); ?> <?php echo e($mouvement->devise ?? $compte->devise); ?></td>
                <td><?php echo e($mouvement->operateur->name ?? 'Système'); ?></td>
            </tr>
    ...
    <!-- Pied de page -->
    <div class="footer">
        <div>Relevé généré le <?php echo e(now()->format('d/m/Y à H:i')); ?></div>
...
</html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/comptes/export-releve.blade.php ENDPATH**/ ?>