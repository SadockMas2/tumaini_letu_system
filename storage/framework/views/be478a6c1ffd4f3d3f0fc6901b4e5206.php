        ...
        <div class="details-card rounded-2xl p-8">
            ...
            <div class="text-center mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-2">
                    Crédit Groupe <span class="text-green-600">#<?php echo e($credit->id); ?></span>
                </h2>
                <div class="flex flex-wrap justify-center gap-4 text-sm text-gray-600 mb-4">
                    <div class="flex items-center bg-green-50 rounded-full px-4 py-2">
                        ...
                        <span class="font-medium"><?php echo e($credit->compte->nom); ?></span>
                    </div>
                    <div class="flex items-center bg-blue-50 rounded-full px-4 py-2">
                        <i class="fas fa-id-card mr-2 text-blue-500"></i>
                        <span class="font-medium"><?php echo e($credit->compte->numero_compte); ?></span>
                    </div>
                    <div class="flex items-center bg-purple-50 rounded-full px-4 py-2">
                        <i class="fas fa-wallet mr-2 text-purple-500"></i>
                        <span class="font-medium"><?php echo e($credit->compte->devise); ?></span>
                    </div>
                </div>
            </div>
                ...
                <div class="stat-card bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-l-green-400">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-2xl font-bold text-green-600">
                            <?php echo e(number_format($credit->montant_accorde ?? 0, 2, ',', ' ')); ?>
                ...
                <div class="stat-card bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-l-purple-400">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-2xl font-bold text-purple-600">
                            <?php echo e(number_format($credit->montant_total ?? 0, 2, ',', ' ')); ?>
                ...
                <div class="stat-card bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-l-blue-400">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-2xl font-bold text-blue-600">
                            <?php echo e(number_format($credit->remboursement_hebdo_total ?? 0, 2, ',', ' ')); ?>
                ...
                <div class="stat-card bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border-l-orange-400">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-2xl font-bold text-orange-600">
                            <?php echo e(number_format($credit->caution_totale ?? 0, 2, ',', ' ')); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200">
                            ...
                            <span class="text-sm text-gray-500 bg-green-100 px-2 py-1 rounded">
                                <?php echo e($credit->date_octroi->format('d/m/Y')); ?>
...
?>
                    ...
                    <div class="grid grid-cols-2 gap-4 text-center">
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                            ...
                            <p class="text-lg font-bold text-green-600">
                                <?php echo e(number_format($montantDejaRembourse, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>
                        ...
                        <div class="bg-white rounded-lg p-3 border border-gray-200">
                           ...
                           <p class="text-lg font-bold text-orange-600">
                                <?php echo e(number_format($resteAPayer, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200 mb-8">
                ...
                <?php if($credit->repartition_membres && count($credit->repartition_membres) > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $credit->repartition_membres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membreId => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
    ...
    <?php if($compteMembre): ?>
        <tr class="border-b border-green-100 hover:bg-green-50 transition-colors">
            <td class="px-4 py-3">
                <div class="font-medium text-gray-800"><?php echo e($compteMembre->nom); ?> <?php echo e($compteMembre->prenom); ?></div>
                <div class="text-xs text-gray-500"><?php echo e($compteMembre->numero_compte); ?></div>
            </td>
            <td class="px-4 py-3 text-right">
                <?php echo e(number_format($montantAccordeMembre, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

            </td>
            <td class="px-4 py-3 text-right">
                <?php echo e(number_format($remboursementHebdoMembre, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

            </td>
            <td class="px-4 py-3 text-right">
                <?php echo e(number_format($cautionMembre, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

            </td>
            <td class="px-4 py-3 text-right">
                <?php echo e(number_format($montantTotalDuMembre, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                <div class="w-full bg-gray-200 rounded-full h-2 mt-1">
                    <div class="bg-green-500 h-2 rounded-full" style="width: <?php echo e($progressionMembre); ?>%"></div>
                </div>
                <div class="text-xs text-gray-500 mt-1">
                    <?php echo e(number_format($progressionMembre, 1)); ?>% (Payé: <?php echo e(number_format($montantPayeParMembre, 2, ',', ' ')); ?>)
                </div>
            </td>
            <td class="px-4 py-3 text-center">
                <?php if($montantRestantMembre <= 0): ?>
                    <span class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800">
                        <i class="fas fa-check mr-1"></i> Payé
                    </span>
                <?php elseif($montantPayeParMembre > 0): ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tfoot>
                                <tr class="bg-green-100">
                                    ...
                                    <td class="px-4 py-3 text-right font-bold text-green-700">
                                        <?php echo e(number_format($credit->montant_accorde, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                                    </td>
                                    <td class="px-4 py-3 text-right font-bold text-blue-700">
                                        <?php echo e(number_format($credit->remboursement_hebdo_total, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                                    </td>
                                    <td class="px-4 py-3 text-right font-bold text-orange-700">
                                        <?php echo e(number_format($credit->caution_totale, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>

                                    </td>
                                    <td class="px-4 py-3 text-right font-bold text-purple-700">
                                        <?php echo e(number_format($credit->montant_total, 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
                <a 
                    href="<?php echo e(route('credits.echeanciers-groupe', $credit->id)); ?>" 
...
</html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/credits/details-groupe.blade.php ENDPATH**/ ?>