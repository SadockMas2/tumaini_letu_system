        ...
        <div class="header">
            ...
            <div class="controls">
                ...
                <div class="control-group">
                    ...
                    <input type="date" id="dateDebut" value="<?php echo e(date('Y-m-d')); ?>">
                </div>
                
                <div class="control-group">
                    <label for="dateFin">Date de Fin</label>
                    <input type="date" id="dateFin" value="<?php echo e(date('Y-m-d', strtotime('+3 months'))); ?>">
                </div>
...
</html><?php /**PATH C:\laragon\www\tumainiletusystem2.0\resources\views/filament/pages/remboursement-par-periode.blade.php ENDPATH**/ ?>