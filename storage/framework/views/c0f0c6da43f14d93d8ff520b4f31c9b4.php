<!--[if BLOCK]><![endif]--><?php if(!isset($type) || !$type): ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div class="p-6 space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900"><?php echo e($type); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600"><?php echo e($montant); ?> <?php echo e($devise); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            ...
                            <p class="text-base font-semibold text-gray-900"><?php echo e($clientNom); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            ...
                            <p class="text-base font-semibold text-gray-900"><?php echo e($compteNumero); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Section Description -->
            <!--[if BLOCK]><![endif]--><?php if($description && $description !== 'Aucune description'): ?>
            <div class="bg-blue-50 border border-blue-100 rounded-lg p-4">
                <div class="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-900 mt-1"><?php echo e($description); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900"><?php echo e(now()->format('d/m/Y H:i:s')); ?></p>
                            </div>
                            <div class="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                                <svg class="w-4 h-4 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\laragon\www\tumainiletusystem2.0\resources\views/filament/operations/confirmation.blade.php ENDPATH**/ ?>