                            ...
                            <div class="frais-item border-l-orange-400 bg-orange-50 rounded-r-lg p-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-lg font-bold text-orange-600">
                                        <?php echo e(number_format($frais['adhesion'], 2, ',', ' ')); ?> <?php echo e($credit->compte->devise); ?>
...
</html><?php /**PATH C:\STORAGE\TUMAINI LETU\System\tumainiletusystem\tumainiletusystem2.0\resources\views/credits/approval.blade.php ENDPATH**/ ?>