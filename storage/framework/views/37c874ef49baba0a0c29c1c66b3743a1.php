...
<body>
    ...
    <div class="ref-date">
        <div>N/REF : RAPP-<?php echo e(\Carbon\Carbon::now()->format('Ymd-His')); ?></div>
    ...
    <div class="section">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $rapport['usd']['caisses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caisse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($caisse['nom']); ?></td>
                    <td class="text-right montant"><?php echo e(number_format($caisse['solde_initial'], 2)); ?></td>
                    <td class="text-right montant"><?php echo e(number_format($caisse['solde_final'], 2)); ?></td>
                    <td class="text-right mouvement-depot montant"><?php echo e(number_format($caisse['depots'], 2)); ?></td>
                    <td class="text-right mouvement-retrait montant"><?php echo e(number_format($caisse['retraits'], 2)); ?></td>
                    <td class="text-center"><?php echo e($caisse['operations']); ?></td>
                </tr>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right mouvement-depot montant"><strong><?php echo e(number_format($rapport['usd']['depots'], 2)); ?></strong></td>
                    <td class="text-right mouvement-retrait montant"><strong><?php echo e(number_format($rapport['usd']['retraits'], 2)); ?></strong></td>
                    <td class="text-center"><strong><?php echo e($rapport['usd']['operations']); ?></strong></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $rapport['cdf']['caisses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caisse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($caisse['nom']); ?></td>
                    <td class="text-right montant"><?php echo e(number_format($caisse['solde_initial'], 2)); ?></td>
                    <td class="text-right montant"><?php echo e(number_format($caisse['solde_final'], 2)); ?></td>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right mouvement-depot montant"><strong><?php echo e(number_format($rapport['cdf']['depots'], 2)); ?></strong></td>
                    <td class="text-right mouvement-retrait montant"><strong><?php echo e(number_format($rapport['cdf']['retraits'], 2)); ?></strong></td>
                    <td class="text-center"><strong><?php echo e($rapport['cdf']['operations']); ?></strong></td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(\Illuminate\Support\Str::limit($mouvement['caisse'], 15)); ?></td>
                    <td>
                    ...
                    <td class="text-right montant <?php echo e($mouvement['type'] === 'depot' ? 'mouvement-depot' : 'mouvement-retrait'); ?>">
                        <?php echo e(number_format($mouvement['montant'], 2)); ?>

                    </td>
                    <td style="font-size: 9px;"><?php echo e(\Illuminate\Support\Str::limit($mouvement['description'], 40)); ?></td>
                    <td style="font-size: 9px;"><?php echo e(\Illuminate\Support\Str::limit($mouvement['nom_deposant'] ?? $mouvement['client_nom'] ?? '-', 15)); ?></td>
...
</html><?php /**PATH D:\APP\TUMAINI LETU\tumainiletusystem2.0\resources\views/pdf/rapport-instantanee.blade.php ENDPATH**/ ?>