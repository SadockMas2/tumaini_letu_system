    ...
    <div class="grid grid-cols-2 gap-4 text-center">
        ...
        <div class="bg-white rounded-lg p-3 border border-gray-200">
            ...
            <p class="text-lg font-bold text-orange-600">
                {{ number_format($resteAPayer, 2, ',', ' ') }} {{ $compte->devise }}
            </p>
        </div>
    </div>
</div>
...
<tbody class="divide-y divide-gray-200">
    ...
    <tr class="mouvement-row hover:bg-gray-50 transition-colors duration-150" data-type="{{ $typePourFiltre }}">
        <td class="px-6 py-4 whitespace-nowrap">
            <div class="text-sm font-medium text-gray-900">
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $badgeClasse }}">
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            <div class="text-sm font-medium {{ $couleurClasse }}">
                {{ $montantAffichage }}
            </div>
        </td>
        <td class="px-6 py-4 whitespace-nowrap">
