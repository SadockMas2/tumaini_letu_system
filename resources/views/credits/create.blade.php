...
<body class="font-sans antialiased">
    <div class="w-full max-w-4xl mx-4">
        ...
        <div class="credit-card rounded-2xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <div class="flex flex-wrap justify-center gap-4 text-sm text-gray-600 mb-4">
                    ...
                    <div class="flex items-center bg-purple-50 rounded-full px-4 py-2">
                        ...
                        <span class="font-medium capitalize">{{ $compte->type_compte }}</span>
                    </div>
                </div>
            </div>
                ...
                <div class="info-item bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-800 capitalize">{{ $compte->type_compte }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('credits.store') }}" method="POST" class="space-y-6" id="creditForm">
                @csrf
                <input type="hidden" name="compte_id" value="{{ $compte->id }}">
                <input type="hidden" name="type_compte" value="{{ $compte->type_compte }}">
     ...
     <script>
        ...
        const compteType = "{{ strtolower($compte->type_compte) }}";
