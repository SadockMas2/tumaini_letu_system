            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="info-card bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-l-blue-400">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-2xl font-bold text-blue-600">
                            {{ number_format($credit->montant_demande, 2, ',', ' ') }}
                        </span>
                    </div>
                ...
                <div class="info-card bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-l-purple-400">
                    ...
                    <p class="text-xs text-gray-500 mt-1">
                        {{ $credit->type_credit === 'individuel' ? 'Individuel' : 'Groupe' }}
                    </p>
                </div>
                ...
                <div class="info-card bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-l-green-400">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-2xl font-bold text-green-600">
                            {{ $credit->type_credit === 'groupe' ? '1.225' : 'Variable' }}
                        </span>
                    </div>
                    <p class="text-sm text-gray-600 font-medium">Coefficient</p>
                    <p class="text-xs text-gray-500 mt-1">
                        {{ $credit->type_credit === 'groupe' ? 'Fixé' : 'Selon montant' }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800">
                            {{ number_format($credit->compte->solde, 2, ',', ' ') }} {{ $credit->compte->devise }}
                        </p>
                    </div>
                    <div>
                            ...
                            <div class="frais-item border-l-blue-400 bg-blue-50 rounded-r-lg p-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-lg font-bold text-blue-600">
                                        {{ number_format($frais['dossier'], 2, ',', ' ') }} {{ $credit->compte->devise }}
                                    </span>
                                </div>
                            </div>
                            <div class="frais-item border-l-green-400 bg-green-50 rounded-r-lg p-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-lg font-bold text-green-600">
                                        {{ number_format($frais['alerte'], 2, ',', ' ') }} {{ $credit->compte->devise }}
                                    </span>
                                </div>
                            </div>
                            <div class="frais-item border-l-purple-400 bg-purple-50 rounded-r-lg p-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-lg font-bold text-purple-600">
                                        {{ number_format($frais['carnet'], 2, ',', ' ') }} {{ $credit->compte->devise }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="frais-item border-l-red-400 bg-red-50 rounded-r-lg p-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-lg font-bold text-red-600">
                                        {{ number_format($frais['caution'], 2, ',', ' ') }} {{ $credit->compte->devise }}
                                    </span>
                                </div>
                            </div>
                        @else
                    ...
                    <div class="p-6 space-y-6">
                        <div class="text-center">
                            ...
                            <p class="text-3xl font-bold montant-total">
                                {{ number_format($montantTotal, 2, ',', ' ') }} {{ $credit->compte->devise }}
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-blue-50 rounded-lg p-4 text-center">
                                ...
                                <p class="text-xl font-bold text-blue-600">
                                    {{ number_format($remboursementHebdo, 2, ',', ' ') }} {{ $credit->compte->devise }}
                                </p>
                            </div>
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div class="text-sm text-yellow-800">
                                    <strong>Note:</strong> Le client devra payer {{ number_format($totalFrais, 2, ',', ' ') }} {{ $credit->compte->devise }} 
                                    de frais avant de recevoir le crédit. La caution de {{ number_format($frais['caution'], 2, ',', ' ') }} {{ $credit->compte->devise }} 
            ...
            @else
                ...
                <div class="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 border border-yellow-200 text-center">
                    ...
                    <p class="text-gray-600">
                        Statut actuel: 
                        <span class="font-semibold capitalize {{ $credit->statut_demande === 'approuve' ? 'text-green-600' : 'text-red-600' }}">
...
<script>
    // Variables globales
    const devise = "{{ $credit->compte->devise }}";
   const remboursementHebdo = {{ floatval($remboursementHebdo ?? 0) }};
const montantTotal = {{ floatval($montantTotal ?? 0) }};
