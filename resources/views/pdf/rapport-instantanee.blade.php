        ...
        <div class="totals-grid">
            ...
            <div class="total-card">
                ...
                <div class="total-value delaisage montant">
                    {{ number_format($rapport['usd']['delaistages'] ?? 0, 2) }} $
                </div>
            </div>
            <div class="total-card">
                <div class="total-label">DÉLAISTAGES CDF</div>
                <div class="total-value delaisage montant">
                    {{ number_format($rapport['cdf']['delaistages'] ?? 0, 2) }} FC
                </div>
            </div>
            <div class="total-card">
                <div class="total-label">OPÉRATIONS USD</div>
                <div class="total-value">{{ $rapport['usd']['operations'] }}</div>
            </div>
            <div class="total-card">
                <div class="total-label">OPÉRATIONS CDF</div>
                <div class="total-value">{{ $rapport['cdf']['operations'] }}</div>
            </div>
        </div>
    </div>
